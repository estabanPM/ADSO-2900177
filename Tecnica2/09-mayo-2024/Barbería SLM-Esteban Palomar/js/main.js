...
let errorNombre = "Formato o tipo no valido. Nombre y apellido completo"
...
do{
    ...
    facturacion += `Seleccione una opción de 1-4 para ver las ganacias. \n`;
    facturacion += `Ganacias individuales: \n`;
    barberia.forEach((data, i) =>{
        facturacion += `${i + 1}. ${data.nombre_barbero} (${data.nivel_profesion})\n`;
    });
    facturacion += `\n========== ganacia global ========== \n`;
    facturacion += `4. Ganancia total de la barbería`;
    ...
    if(opcionFactura == 4){
        barberia.forEach((data, i)=>{
            infoFactura += `\n========== Ganacias totales ===========\n`;
            infoFactura += `\n${data.nombre_barbero} : clientes: ${data.clientes.length}  -- ganacia generada: $${montoDinero[i]}\n`;
        });
        infoFactura+= `\n......................................................................`
        infoFactura+=`\nGanacias total de la barbería: $${ganaciaTotal}`;
        infoFactura+= `......................................................................`
        infoFactura += `\nPara volver al menu de facturación ingrese el número 1.\nPara salir de todo el sistema ingrese el número 2.`;
    }else{
        ...
        infoFactura +=  `Cantida de clientes del Barbero: ${barberoLocation.nombre_barbero}\n`;
